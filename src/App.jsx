            ...
            <div className="col-lg-4">
              <div className="about-card text-center h-100">
                ...
                <div className="d-flex justify-content-center gap-3">
                  ...
                  <a href="https://space.bilibili.com/40214866" target="_blank" rel="noopener noreferrer" className="text-white"><i className="bi bi-camera-video fs-4"></i></a>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-md-6 text-center text-md-end">
              <div className="social-links">
                ...
                <a href="https://space.bilibili.com/40214866" target="_blank" rel="noopener noreferrer"><i className="bi bi-camera-video"></i></a>
